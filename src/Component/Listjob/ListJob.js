...
const ListJob = () => {
    return (
    <>
        <Container className="mb-5 gerg">
            <Card className="p-3">
                <Card.Body>
                    <Card.Title className="efbu">Senior Product Manager - Security Experience</Card.Title>
                    <Card.Text className="sefbiu">
                        ...
                        <h6>Jl.Kemang Raya, Jakarta Selatan</h6>
                        </div>
            ...
            <Card className="p-3">
                <Card.Body>
                    <Card.Title className="efbu">Senior Analytics Engineer - Payments & Partnerships</Card.Title>
                    <Card.Text className="sefbiu">
                        <div className="sefbiu mr-5">
                        <svg width="30" height="30">
                        <path fill="#696868" fill-rule="evenodd" d="M.314 7.58C.11 6.988 0 6.35 0 5.684 0 2.544 2.462 0 5.5 0S11 2.544 11 5.683c0 .665-.11 1.304-.314 1.898h.02l-.074.154c-.166.44-.383.856-.644 1.236-1.21 2.19-2.702 4.2-4.478 6.03-2.306-2.163-4.048-4.636-5.225-7.42h.03zm5.186.376c1.215 0 2.2-1.018 2.2-2.273 0-1.255-.985-2.273-2.2-2.273-1.215 0-2.2 1.018-2.2 2.273 0 1.255.985 2.273 2.2 2.273z"></path>
                        ...
                        <h6>Data Science and Engineering</h6>
                        </div>
                    </Card.Text>
                </Card.Body>
            </Card>
            <Card className="p-3">
                <Card.Body>
                    <Card.Title className="efbu">Manager, Transportation</Card.Title>
                    <Card.Text className="sefbiu">
                        <div className="sefbiu mr-5">
                        <svg width="30" height="30">
                        <path fill="#696868" fill-rule="evenodd" d="M.314 7.58C.11 6.988 0 6.35 0 5.684 0 2.544 2.462 0 5.5 0S11 2.544 11 5.683c0 .665-.11 1.304-.314 1.898h.02l-.074.154c-.166.44-.383.856-.644 1.236-1.21 2.19-2.702 4.2-4.478 6.03-2.306-2.163-4.048-4.636-5.225-7.42h.03zm5.186.376c1.215 0 2.2-1.018 2.2-2.273 0-1.255-.985-2.273-2.2-2.273-1.215 0-2.2 1.018-2.2 2.273 0 1.255.985 2.273 2.2 2.273z"></path>
                        ...
                        <h6>Facilities, Workplace Services and Real Estate</h6>
                        </div>
                    </Card.Text>
                </Card.Body>
            </Card>
            <Card className="p-3">
                <Card.Body>
                    <Card.Title className="efbu">Manager, Corporate Safety</Card.Title>
                    <Card.Text className="sefbiu">
                        <div className="sefbiu mr-5">
                        <svg width="30" height="30">
                        <path fill="#696868" fill-rule="evenodd" d="M.314 7.58C.11 6.988 0 6.35 0 5.684 0 2.544 2.462 0 5.5 0S11 2.544 11 5.683c0 .665-.11 1.304-.314 1.898h.02l-.074.154c-.166.44-.383.856-.644 1.236-1.21 2.19-2.702 4.2-4.478 6.03-2.306-2.163-4.048-4.636-5.225-7.42h.03zm5.186.376c1.215 0 2.2-1.018 2.2-2.273 0-1.255-.985-2.273-2.2-2.273-1.215 0-2.2 1.018-2.2 2.273 0 1.255.985 2.273 2.2 2.273z"></path>
            ...
            <Card className="p-3">
                <Card.Body>
                    <Card.Title className="efbu">Manager, Content FP&A</Card.Title>
                    <Card.Text className="sefbiu">
                        <div className="sefbiu mr-5">
                        <svg width="30" height="30">
                        <path fill="#696868" fill-rule="evenodd" d="M.314 7.58C.11 6.988 0 6.35 0 5.684 0 2.544 2.462 0 5.5 0S11 2.544 11 5.683c0 .665-.11 1.304-.314 1.898h.02l-.074.154c-.166.44-.383.856-.644 1.236-1.21 2.19-2.702 4.2-4.478 6.03-2.306-2.163-4.048-4.636-5.225-7.42h.03zm5.186.376c1.215 0 2.2-1.018 2.2-2.273 0-1.255-.985-2.273-2.2-2.273-1.215 0-2.2 1.018-2.2 2.273 0 1.255.985 2.273 2.2 2.273z"></path>
